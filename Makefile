...
help:
	...
	@printf "  make build         - Build the ykc CLI binary\n"
	...
	@printf "  make publish-homebrew-formula - Push dist/homebrew/yunku-cli.rb to a tap repo\n"
...
fmt:
	@find cmd internal pkg test -name '*.go' -print0 2>/dev/null | xargs -0r gofmt -w
