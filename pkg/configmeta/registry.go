...
// based configuration items used by the ykc CLI.  Each package registers its
// own items via init(), and the "ykc config list" command reads the registry
...
type ConfigItem struct {
	Name         string   // Environment variable name, e.g. "YKC_CONFIG_DIR"
